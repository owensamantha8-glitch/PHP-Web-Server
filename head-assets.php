...
const LUM_LOGIN_PAGE = '/Sec/login.php';
...
function lum_pw_restart($timeout = false) {
    ...
    header('Location: ' . rtrim(LUM_APP_URL, '/') . LUM_LOGIN_PAGE . ($timeout ? '?timeout=1' : ''));
    exit();
}
        ...
        if (!$db) {
            ...
            try {
                ...
                if (!$row || $row['user_status'] === 'Disabled') {
                    ...
                    header('Location: ' . rtrim(LUM_APP_URL, '/') . '/index.php');
                    exit();
                }
            } catch (\Throwable $e) {
        ...
        <div class="col-12 col-md-8 col-lg-5 col-xl-4">
            <div class="card login-container p-4">
                <div class="text-center mb-4">
                    <img src="<?php echo htmlspecialchars(rtrim(LUM_APP_URL, '/')); ?>/Additions/Style-Login/LUM-login-logo.png" alt="Lynx Utilities Logo" class="logo-img">
                </div>
                ...
                <form action="" method="POST" autocomplete="off">
                    ...
                    <div class="text-center mt-4 d-flex justify-content-center gap-2">
                        <a href="<?php echo htmlspecialchars(rtrim(LUM_APP_URL, '/') . '/Sec/logout.php'); ?>" class="btn btn-outline-secondary">Cancel</a>
