...
// =========================================================================
// DATABASE CONNECTION: MySQL server level for the yearly OBIS databases ($obis_db_conn)
// (no default database, so db_obis_<code>_<year> of any year can be queried)
